  ...
  render() {
    return (
      <div className="gutter-example" style={{ width: '100%;', height: '100%', padding: '30px' }}>
        <Row
          gutter={16}
          style={{ background: '#fff', margin: '0px', padding: '10px 30px', textAlign: 'center' }}
        >
          <Button type="info" className="act-btn" onClick={this.initView}>
            初始化流程图
          </Button>
          <Button type="primary" className="act-btn" onClick={this.addNode}>
            给选中节点增加子节点
          </Button>
          <Button type="primary" className="act-btn" onClick={this.addAlphaChild}>
            给Alpha增加子节点
          </Button>
          <Button type="danger" className="act-btn" onClick={this.deleteNode}>
            删除节点
          </Button>
          <Button type="info" className="act-btn" onClick={this.getSelectedKeys}>
            获取选中节点
          </Button>
          <Button type="primary" className="act-btn" onClick={this.changeNodeColor}>
            更新节点颜色
          </Button>
        </Row>
        <BasicGojs
