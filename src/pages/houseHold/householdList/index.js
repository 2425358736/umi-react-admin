  ...
  infoJson: [
    {
      ...
      children: [
        {
          title: '发送方式',
          dataIndex: 'informationChannelStr',
        },
        {
          title: '消息类型',
          dataIndex: 'informationTypeStr',
        },
        {
          title: '标题',
    ...
    },
    {
      ...
      children: [
        {
          title: '内容',
          dataIndex: 'informationContent',
        },
        {
          title: '消息状态',
          dataIndex: 'informationStateStr',
        },
        {
          title: '发送时间',
        ...
        <BaseTable
          ...
          search={
            <Search
              ...
              operationBlock={[
                <Add key="1" title="迁入" component={MoveIn} />,
          ...
          info={
            <Info
              identifying="informationTitle"
              title="站内信详情"
              infoUrl={SYS_INFO_INFO}
